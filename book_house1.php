          ...
          <div class="book-house">
           ...
           <center>
            ...
            <?php
                ...
                $imgcode=$_GET['ic'];
                $query="SELECT * FROM bachelor_images WHERE code='$imgcode' ";
    ...
    //echo $value ['Email'], " ", "<br>";
        ...
        echo  "</td> </tr>";
            ...
            <div class="booking-details">
                ...
                <form action="book_house1.php" method="POST">
                ...
                <input type="text" name="house_Name" value="<?php echo $_GET['ic']; ?>" required="true"><br/>
