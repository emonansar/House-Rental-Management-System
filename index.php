...
<body bgcolor="silver">
    ...
    <header class="header">
    	<div class="wrapper">
            ...
            <input type="text" class="searchTerm" name="search" placeholder="Search Family Houses Location" required="true">
    ...
    <nav class="menu">
    	<div class="Link">
    		<ul>
    			...
    			<a href="about.htm"><li><b>About</b></li></a>
    			<a href="sign.php"><li><b>Houses</b></li></a>
    			<a href="sign.php"><li><b>Contact</b></li></a>
    			<a href="sign.php"><li><b>Sign In</b></li></a>
                <a href="login.php"><li><b>Admin</b></li></a>
                <a href="sign.php"><li><b>Live Chat</b></li></a>
    		</ul>
    	</div>
    </nav>
    <!-Menu Ends here->
        ...
        <?php echo "</td>";
    		...
    		<div class="clearfix">
                 <?php
                       ...
                       echo "<center>";
                      echo "<table  align='center' border='1'  bgcolor='silver' bordercolor='white'>";
                     echo "<tr ><th style='color:blue'>Image</th><th style='color:blue'>Image Code</th><th style='color:blue'>Time</th><th style='color:blue'>Location</th><th style='color:blue'>Book here</th></tr>";
                       while ($row=mysql_fetch_array($res)) {
