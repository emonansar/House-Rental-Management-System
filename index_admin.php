    ...
    <div class="main">
    	...
    	<div class="wrapper">
           ...
           <?php
                     ...
                     echo "<tr ><th style='color:blue'>Image</th><th style='color:blue'>Image Code</th><th style='color:blue'>Time</th><th style='color:blue'>Location</th><th style='color:blue'>Time</th><th style='color:blue'>Contact</th><th style='color:blue'>Book here</th><th colspan='2' style='color:blue'>Operations</th></tr>";
                ...
                echo "<td bgcolor='aqua' style='color:white'>"; ?> <span class="house-Location"><?php echo $row["time"] ?></span><br/><?php echo "</td>";
                echo "<td bgcolor='aqua' style='color:white'>"; ?> <span class="house-Location"><?php echo $row["contact"] ?></span><br/><?php echo "</td>";
               echo "<td>"; ?> <?php echo "<a href='book_house.php?ic=$row[Name]'>";?><button style="background-color: purple;color: white;" type="button" class="btn-book">Book House</button> </a>
    	        ...
    	        <?php echo "<td> <a href='update_photo.php?nm=$row[Name]&lc=$row[location]&dc=$row[description]&im=$row[images]&mb=$row[contact]&tm=$row[time]'>UPDATE</a> "?>
                <?php echo "</td>";echo"</tr>";
                                                         }
                        echo "</table>";
                       ?>
    		...
    		<?php
                ...
                echo "<td bgcolor='aqua' style='color:white'>"; ?> <span class="house-Location"><?php echo $row["location"] ?></span><br/><?php echo "</td>";
                 echo "<td bgcolor='aqua' style='color:white'>"; ?> <span class="house-Location"><?php echo $row["time"] ?></span><br/><?php echo "</td>";
                echo "<td bgcolor='aqua' style='color:white'>"; ?> <span class="house-Location"><?php echo $row["Mobile"] ?></span><br/><?php echo "</td>";
                echo "<td>"; ?> <a href="sign.php" ><button style="background-color: purple;color: white;" type="button" class="btn-book">Book House</button> </a>
                <?php echo "<td> <a href='delete_image1.php?iid=$row[code]'>DELETE</a> "?>
                <?php echo "<td> <a href='update_photo1.php?nm=$row[code]&lc=$row[location]&dc=$row[description]&im=$row[images]&mb=$row[Mobile]&tm=$row[time]'>UPDATE</a> "?>
